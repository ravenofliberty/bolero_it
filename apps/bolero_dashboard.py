...
if __name__ == "__main__":
    ...
    if st.checkbox(f"Open practice section"):
        ...
        word_per_test = st.slider("How many words in one test", min_value=2, max_value=len(words), value=10)
        ...
        if mode == "Insert":
            ...
            if submitted_insert:
                json = {
                    ...
                    "practice_data": {
                        "to_ger": {datetime.datetime.now().isoformat(): False},
                        "to_eng": {datetime.datetime.now().isoformat(): False},
                    },
                    "verb_forms": {
                        "ich": ich,
                        "du": du,
